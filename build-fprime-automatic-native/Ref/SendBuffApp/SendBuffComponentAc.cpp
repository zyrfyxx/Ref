...
namespace Ref {
  ...
  void SendBuffComponentBase::loadParameters() {
  ...
  // ----------------------------------------------------------------------
    ...
    SendBuffComponentBase :: SendBuffComponentBase(const char* compName) :
  ...
  void SendBuffComponentBase ::
    tlmWrite_PacketsSent(U64 arg, Fw::Time _tlmTime)
  {
  ...
  void SendBuffComponentBase ::
    tlmWrite_NumErrorsInjected(U32 arg, Fw::Time _tlmTime)
  {
  ...
  void SendBuffComponentBase ::
    tlmWrite_Parameter3(U8 arg, Fw::Time _tlmTime)
  {
    // Check to see if it is the first time
  ...
  void SendBuffComponentBase ::
    tlmWrite_Parameter4(F32 arg, Fw::Time _tlmTime)
  {
    // Check to see if it is the first time
  ...
  void SendBuffComponentBase ::
    tlmWrite_SendState(const Ref::SendBuff_ActiveState& arg, Fw::Time _tlmTime)
  {
    if (this->m_Tlm_OutputPort[0].isConnected()) {
      if (this->m_Time_OutputPort[0].isConnected() && _tlmTime ==  Fw::ZERO_TIME) {
         this->m_Time_OutputPort[0].invoke( _tlmTime);
    ...
    )
  {
    ...
    if (this->m_LogText_OutputPort[0].isConnected()) {
      ...
      const char* _formatString =
        "(%s) %s: First packet ID %u received";
#else
      const char* _formatString =
        "%s: First packet ID %u received";
#endif
...
#if FW_OBJECT_NAMES == 1
      const char* _formatString =
        "(%s) %s: Inserted error in packet ID %u";
#else
      const char* _formatString =
        "%s: Inserted error in packet ID %u";
#endif
...
#if FW_OBJECT_NAMES == 1
      const char* _formatString =
        "(%s) %s: BuffSend Parameter %u was updated";
#else
      const char* _formatString =
        "%s: BuffSend Parameter %u was updated";
#endif
