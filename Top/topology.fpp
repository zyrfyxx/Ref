module Ref {
  ...
  topology Ref {
    ...
    instance doActions
    instance getEnvData
    instance getCtrlData
    instance processData
    instance processInData
    instance processOutData
    instance thrDistribute
    instance protectFromSunlight
    ...
    connections RateGroups {
      ...
      rateGroup1Comp.RateGroupMemberOut -> thrDistribute.schedIn
    ...
    connections Ref {
      ...
      control.doActionsOut -> doActions.doActionsIn

      setSensorState.getEnvDataOut -> getEnvData.getEnvDataIn
      setSensorState.getCtrlDataOut -> getCtrlData.getCtrlDataIn
      setSensorState.processDataOut -> processData.processDataIn
      
      processData.processInDataOut -> processInData.processInDataIn
      processData.processOutDataOut -> processOutData.processOutDataIn

      doActions.thrDistributeOut -> thrDistribute.thrDistributeIn
      doActions.protectFromSunlightOut -> protectFromSunlight.protectFromSunlightIn
