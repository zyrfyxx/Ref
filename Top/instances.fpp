module Ref {
  ...
  instance control: Ref.Control base id 0x0E00 \
    queue size Default.queueSize \
    stack size Default.stackSize \
    priority 100
  ...
  instance thrDistribute: Ref.ThrDistribute base id 0x02700 \
    queue size Default.queueSize
  ...
  instance doActions: Ref.DoActions base id 0x04C00

  instance setSensorState: Ref.SetSensorState base id 0x04D00

  instance getEnvData: Ref.GetEnvData base id 0x04E00

  instance processData: Ref.ProcessData base id 0x04F00

  instance processInData: Ref.ProcessInData base id 0x05000

  instance processOutData: Ref.ProcessOutData base id 0x05100

  instance getCtrlData: Ref.GetCtrlData base id 0x05200

  instance protectFromSunlight: Ref.ProtectFromSunlight base id 0x05300
